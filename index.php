      ...
      <div class="panel panel-success" id="loginBox">
        ...
        <div class="panel-body">
          <form onSubmit="return validationForm();" role="form" id="form" method="post">
            ...
            <hr />
            <div align="center">
              <button style="width:100%;background-color:#007BFF !important;border-color:#007BFF !important;" type="submit" id="login" class="btn btn-success"><i class="fa fa-key"  ></i>&nbsp;<?php echo $_data['_login'];?></button>
            </div>
          </form>
        </div>
      </div>
