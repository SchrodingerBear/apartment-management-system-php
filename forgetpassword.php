        ...
        <div class="panel-body">
          <form role="form" id="form" method="post">
            ...
            <div class="form-group">
              <button style="width:100%;background-color:#007BFF !important;border-color:#007BFF !important;" type="submit" id="login" class="btn btn-primary"><?php echo $_data['btn_submit']; ?></button>
            </div>
