...
# Define valid commit dates
valid_days = [16] + list(range(21, 27))  # February 16 and 21-26
...
for file in files:
    while True:
        ...
        # Ensure the date is in February and matches the valid days
        if commit_date.month == 2 and commit_date.day in valid_days:
            break
